...
export class AccessTokenGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    try {
      ...
      // if(accessToken==="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJiMTI0MmVjNy02ZGE5LTRhYTQtOGY4ZC1mM2NkYTE5Mjg3NGQiLCJpYXQiOjE3MDkzOTk0MDAsImV4cCI6MTcwOTQ4NTgwMH0.JF-UVM3ZQGFiS1hNLMDJ5lKYL4J7IrDMs23Jyvlfnb8")
      //  return true;
